...
describe('careers data module', () => {
  ...
  it('exports exactly 4 employment entries', () => {
  ...
  it('every entry has logoCopyrightNotice as optional string', () => {
    for (const career of careers) {
      expect(
        career.logoCopyrightNotice === undefined || typeof career.logoCopyrightNotice === 'string'
      ).toBe(true);
    }
  });
