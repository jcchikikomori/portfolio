...
export const projects: Project[] = [
  ...
  },
  {
    ...
    careerId: 'gorated',
    description:
      'Developed custom WordPress themes with PHP7, NodeJS, SASS & HTML5. Built custom plugins to fulfill business needs. Implemented site security using OWASP Top Ten standards.',
    dates: '2019',
    url: null,
    ...
    skills: [
      { name: 'Web Application Development', icon: 'bi-window' },
      { name: 'Git', icon: 'bi-git' },
      { name: 'Continuous Integration (CI)', icon: 'bi-arrow-repeat' },
      { name: 'PHP', icon: 'bi-filetype-php' },
      { name: 'jQuery', icon: 'bi-filetype-js' },
      { name: 'Node.js', icon: 'bi-hdd-network' },
  ...
  },
  {
    ...
    careerId: 'gorated',
    description:
      'Maintained McDelivery PH (2018 version) for Android until 2021. Android food delivery application with real-time order tracking.',
    dates: '2020 - 2021',
    ...
    platforms: ['bi-android', 'bi-phone'],
    skills: [
      { name: 'Continuous Delivery (CD)', icon: 'bi-cloud-arrow-up' },
      { name: 'Amazon Web Services (AWS)', icon: 'bi-cloud' },
      { name: 'Docker', icon: 'bi-box' },
      { name: 'Gradle', icon: 'bi-gear' },
      { name: 'Git', icon: 'bi-git' },
      { name: 'Firebase', icon: 'bi-fire' },
      { name: 'Continuous Integration (CI)', icon: 'bi-arrow-repeat' },
      { name: 'RxJava', icon: 'bi-lightning' },
      { name: 'Android Development', icon: 'bi-android' },
      { name: 'PayMaya', icon: 'bi-credit-card' },
      { name: 'GCash', icon: 'bi-wallet' },
    ],
  ...
  // Personal Projects
  {
    ...
    dates: '2017 - present',
    url: 'https://github.com/jcchikikomori/hello-php',
  ...
  },
  {
    ...
    industry: 'llm',
    careerId: null,
    description: 'Skills Repository for Claude Code & opencode',
    dates: '2025 - present',
    url: 'https://github.com/jcchikikomori/skills-md',
    logo: 'https://logo.clearbit.com/github.com',
    logoDark: 'https://logo.clearbit.com/github.com',
    platforms: ['bi-terminal', 'bi-github', 'bi-robot'],
    skills: [
      { name: 'Shell', icon: 'bi-terminal' },
      { name: 'Documentation', icon: 'bi-file-text' },
      { name: 'Open Source', icon: 'bi-github' },
      { name: 'AI/ML', icon: 'bi-robot' },
      { name: 'DevOps', icon: 'bi-gear' },
      { name: 'Markdown', icon: 'bi-markdown' },
    ],
    screenshots: [],
  },
];
